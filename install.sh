...
if [[ ! -t 0 ]]; then
  ...
  echo "  bash <(curl -fsSL https://raw.githubusercontent.com/Mandrhax/Leksis/v1.0.4/install.sh)"
  echo ""
  echo "Or download it first:"
  echo "  curl -fsSL https://raw.githubusercontent.com/Mandrhax/Leksis/v1.0.4/install.sh -o install.sh"
